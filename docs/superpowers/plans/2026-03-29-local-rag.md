...
**Tech Stack:** Python 3.11+, lightrag-hku, Ollama (llama3.1:8b + nomic-embed-text), pymupdf, python-docx, openpyxl, bibtexparser, pyyaml, requests, mcp (Anthropic SDK)
...
```bash
ollama list
# Expected: llama3.1:8b e nomic-embed-text listados
```
...
VALID_CONFIG = {
    ...
    "ollama": {"llm_model": "llama3.1:8b", "embedding_model": "nomic-embed-text"},
...
def test_load_valid_config(tmp_path):
    ...
    assert config["ollama"]["llm_model"] == "llama3.1:8b"
